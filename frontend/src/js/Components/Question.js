...
export class Question extends Phaser.GameObjects.Container{
    constructor(scene, iName, amount, player, credit_text, progressBar){
        ...
        const url  = "https://162.246.157.181/"+ this.player.gamestateId + "/question";
    ...
    sendForm() {
        ...
        const check_url  = "https://162.246.157.181/"+ this.game_id + "/question";
        PutCheckAnswerRequest(ret, this.question, check_url).then(answer => {
          ...
          if(answer.message == "Answer is correct."){
            ...
            const pt_url    = "https://162.246.157.181/createquestionhistory";
            const ptid_url  = "https://162.246.157.181/"+this.player.id+"/getplaythrough";
            ...
            var q_url = "https://162.246.157.181/"+ this.player.gamestateId + "/question";
              ...
              GetAllShoppingList(shop_url).then(ret => {
                for(var i=0; i<ret.length; i++){
                  if(this.imageName == ret[i].itemName){
                    ...
                    var updateShop_url =  "https://162.246.157.181/updateshoppinglist";
