...
export class LevelUpScene extends Phaser.Scene {
    ...
    create(){
        ...
        const url = "https://162.246.157.181/updateplaythrough";
        ...
        this.continueBtn.rect.on("pointerdown", ()=>{
            ...
            if (this.click == 1){
                ...
                const drop_url = "https://162.246.157.181/dropquestion";
                DropQuestionRequest(this.player.gs_id, drop_url).then(data => {})
                const dropShopping_url = "https://162.246.157.181/dropshoppinglist";
