...
export class PartyInterface extends Phaser.Scene {
  ...
  constructor() {
    super({ key: CST.SCENES.PARTY_INTERFACE });
  }
  ...
  bottom_menu() {
    ...
    this.assets = { furniture : ["chair" ,"dinnerTable", "sofa"] ,
    ...
    this.bottomBtn4 = new ButtonAtBottom({  scene       : this,
                                            ...
                                            btnWidth    : btnWidth,
                                            btnColor    : btnColor,
                                            assets      : this.assets.kiddie,
                                            itemY       : itemY
                                          });

    this.bottom_furniture();
    this.bottom_deco();
    this.bottom_food();
    this.bottom_kiddie();
  }
